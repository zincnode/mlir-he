...
import gc, sys
from mlir_he.ir import *
from mlir_he.passmanager import *
from mlir_he.dialects.func import FuncOp
from mlir_he.dialects.builtin import ModuleOp
...
def testCapsule():
    with Context():
        ...
        assert '"mlir_he.passmanager.PassManager._CAPIPtr"' in repr(pm_capsule)
        pm._testing_release()
